...
if getattr(sys, 'frozen', False):
    ...
    app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgresql://postgres.tocstcvgltxhzuuizwrx:DemixInvoice1@aws-1-ap-southeast-1.pooler.supabase.com:443/postgres?sslmode=require')
